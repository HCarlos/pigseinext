...
import getUserAuth, { User } from "@/app/api/getUserAuth.jsx";
...
const Profile = () => {
  ...
  return (
    <DefaultLayout>
      <div className="mx-auto max-w-242.5 border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark-2 text-black dark:text-white ">
        ...
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5  text-black dark:text-white">
            <div
              ...
              <div className="relative drop-shadow-2">
                <Image
                    ...
                    alt="profile"
                    className={"full rounded-full  object-center"}
                />
                <label
                    htmlFor="profile"
            ...
            <div className="mt-4">
              ...
              <p className="font-medium  text-black dark:text-white">{user.ap_paterno}</p>
              <div
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5  text-black dark:text-white text-justify">
                  {user.bio}
                </p>
              </div>
